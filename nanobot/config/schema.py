...
class AgentDefaults(Base):
    ...
    enable_reasoning: bool = True  # Enable reasoning/thinking output display


class RoleModelConfigSchema(Base):
    """Schema for role-specific model configuration in config file."""
...
class RoleConfigSchema(Base):
    """Schema for role configuration in config file."""

    enabled: bool = True
    config: RoleModelConfigSchema | None = None
...
class UploadConfig(Base):
    ...
    allowed_doc_types: list[str] = Field(
        default_factory=lambda: [".pdf", ".doc", ".docx", ".txt", ".md", ".csv", ".xlsx", ".xls", ".pptx"]
    )
...
class AgentsConfig(Base):
    ...
    roles: dict[str, RoleConfigSchema] = Field(default_factory=dict)
...
class WebUIAuthConfig(Base):
    ...
    enabled: bool = False
    password: str = ""  # Fixed password for authentication
    whitelist_file: str = "~/.nanobot/whitelist.json"  # Path to whitelist file
...
class KnowledgeIndexConfig(Base):
    """Knowledge index configuration for hybrid retrieval."""
